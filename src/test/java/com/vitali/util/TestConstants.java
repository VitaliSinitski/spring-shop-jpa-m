...
public class TestConstants {
    ...
    public static final CartItemCreateDto CART_ITEM_CREATE_DTO = CartItemCreateDto.builder().quantity(QUANTITY_TWO).productId(PRODUCT_ID_ONE).cartId(CART_ID_ONE).build();
    public static final Product PRODUCT_ONE = Product.builder().name(PRODUCT_NAME).build();
    public static final Product PRODUCT_TWO = Product.builder().name(PRODUCT_NAME).build();
    public static final Product PRODUCT = Product.builder().price(PRODUCT_PRICE_TEN).build();
    public static final ProductReadDto PRODUCT_READ_DTO_ONE = ProductReadDto.builder().name(PRODUCT_NAME).build();
    ...
    public static final ProductFilter PRODUCT_FILTER = ProductFilter.builder()
            .name(PRODUCT_NAME)
            .categoryId(CATEGORY_ID)
            .producerId(PRODUCER_ID)
            .price(PRODUCT_PRICE_ONE_HUNDRED)
            .minPrice(PRODUCT_PRICE_FIFTY)
            .maxPrice(PRODUCT_PRICE_ONE_HUNDRED_FIFTY)
            .build();
}
